 ...
 *
 * @par Design Pattern
 * Static utility class using Qt's cross-platform QGuiApplication::queryKeyboardModifiers()
 * Works on both X11 and Wayland without platform-specific code.
 *
 * @par Thread Safety
 * All methods must be called from the main/UI thread (uses QGuiApplication).
 *
 * @par Usage Example
 * @code
